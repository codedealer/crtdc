...
export let priest = {
  ...
  token: 'priest',
  disclosed: false,
  description: 'Один раз за игру, до того как другие заявяи, кого они поддерживают, вы можете предотвратить дуэль. Если атакующий имеет хотя бы 2 предмета, он должен отдать вам один предмет по своему выбору. Ход атакующего тут же заканчивается.'
}
...
export let duelist = {
  ...
  token: 'duelist',
  disclosed: false,
  description: 'Один раз за игру, если вы атакуете или защищаетесь, вы можете заявить, что гикто не должен оказывать поддержку в этой дуэли. Также вы поулчаете +1 в этой дуэли.'
}
